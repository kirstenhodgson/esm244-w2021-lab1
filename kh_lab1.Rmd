...
Keep only observations (rows) for Blackwood acacia trees
...
blackwood_acacia_sp <- blackwood_acacia %>% 
  ...
  st_as_sf(coords = c("longitude", "latitude")) #Always in long-lat order

st_crs(blackwood_acacia_sp) = 4326 #Set CRS
...
Combine blackwood acacia tree observations and SF road rap:
